  ...
  return (
    <div style={{ padding: "20px", maxWidth: "1000px", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", gap: "10px", marginBottom: "20px" }}>
        <button onClick={fetchStorageAccounts} style={buttonStyle}>🔄 Odśwież</button>
        <button onClick={() => setShowStorageModal(true)} style={buttonStyle}>➕ Utwórz Storage Account</button>
      </div>
            ...
            {accounts.map((acc, idx) => (
              <tr key={idx}>
                ...
                <td style={tdStyle}>
                  ...
                  <button onClick={() => openBlobModal(acc)} style={{ marginLeft: "5px" }}>📁 Kontener</button>
                </td>
              </tr>
            ))}
          </tbody>
